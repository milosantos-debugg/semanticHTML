...
<body>
    <COMPLETAR>
        <COMPLETAR>Mi Blog - Aplicando HTML Semántico</COMPLETAR>
    </COMPLETAR>
    
    <COMPLETAR>
        <COMPLETAR>
            <COMPLETAR><a href="#">Inicio</a></COMPLETAR>
            <COMPLETAR><a href="#">Sobre mí</a></COMPLETAR>
            <COMPLETAR><a href="#">Contacto</a></COMPLETAR>
        </COMPLETAR>
    </COMPLETAR>
    
    <COMPLETAR>
        <COMPLETAR>
            <COMPLETAR>Título de Sección 1</COMPLETAR>
            <COMPLETAR>
        ...
        <COMPLETAR>
            <COMPLETAR>Título de Sección 2</COMPLETAR>
            <COMPLETAR>
                <h3>Título del Artículo 1</h3>
                <img src="https://media.istockphoto.com/id/1222357475/vector/image-preview-icon-picture-placeholder-for-website-or-ui-ux-design-vector-illustration.jpg?s=612x612&w=0&k=20&c=KuCo-dRBYV7nz2gbk4J9w1WtTAgpTdznHu55W9FjimE=" alt="Imagen"/>
                <p>Este es el contenido del primer artículo. Aquí se desarrolla el tema principal.</p>
    ...
    <COMPLETAR>
        ...
        <COMPLETAR>
            <COMPLETAR><a href="#">Artículo relacionado 1</a></COMPLETAR>
            <COMPLETAR><a href="#">Artículo relacionado 2</a></COMPLETAR>
            <COMPLETAR><a href="#">Artículo relacionado 3</a></COMPLETAR>
        </COMPLETAR>
    </COMPLETAR>

    <!-- No modificar este <div> -->
